...
FILES = {{{'JILL_024.csv','JILL_025.csv','JILL_027.csv','JILL_028.csv'}, [0.0, 10.0, 40.0, 70.0, 100.0, 120.0], [33, 33, 43, 37], [2, 2, 2, 2], 'unobrstucted at 15cm'},
         {{'JILL_029.csv','JILL_030.csv','JILL_031.csv','JILL_032.csv'}, [0.0, 10.0, 40.0, 70.0, 100.0, 110.0], [39, 35, 37, 41], [2, 2, 2, 2], 'unobrstucted at 51cm'},
         {{'JILL_033.csv','JILL_034.csv','JILL_035.csv','JILL_036.csv'}, [0.0, 10.0, 40.0, 70.0, 100.0, 130.0], [42, 32, 37, 39], [121, 121, 121, 121], 'unobrstucted at 78cm'},
