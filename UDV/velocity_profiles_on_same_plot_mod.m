...
FILES = {{{'JILL_024.csv','JILL_025.csv','JILL_027.csv','JILL_028.csv'}, [0.0, 10.0, 40.0, 70.0, 100.0, 120.0], [33, 33, 43, 37], [2, 2, 2, 2], 'unobstructed at 15cm'},
        ...
        {{'JILL_044.csv'}, [20.0, 35.0, 150.0], [31], [2], 'at 2cm obstacle'},        
        {{'JILL_047.csv'}, [40.0, 50.0, 170.0], [38], [2], 'at 4cm obstacle'},        
        {{'JILL_050.csv'}, [60.0, 75.0, 150.0], [32], [2], 'at 6cm obstacle'}, 
        {{'JILL_053.csv'}, [100.0, 115.0, 200.0], [31], [2], 'at 10cm obstacle'}},        
